 ...
 */
JSONSampleList.prototype.read = function(force) {
	var self = this;
	if (this.data && !force) {
...
JSONSampleList.prototype.merge = function(jsonSampleList, force) {
	return Promise
...
JSONSampleList.prototype.add = function(jsonSampleListEntry, force) {
	return this.read()
		.then(function(data) {
...
JSONSampleList.prototype.write = function() {
	if (this.isReadOnly) {
		return Promise.reject(new Error("Cannot write: JSONSampleList is read-only."));
	}
	if (!this.data) {
